...
+ (NSDictionary *)configuration;
{
    ...
    if ([[configuration objectForKey:kNXOAuth2AccountStoreConfigurationTokenURL] isEqual:[NSURL URLWithString:kWPWordPressSandboxAccessTokenURL]]) {
        [config setObject:[NSNumber numberWithBool:YES] forKey:kWPConfigurationSandbox];
    } else {
        [config setObject:[NSNumber numberWithBool:NO] forKey:kWPConfigurationSandbox];
    }
